    ...
    <div className="bg-white dark:bg-gray-900 transition-colors duration-500 shadow-md h-[10vh] w-full flex items-center fixed z-50">
      ...
      <div className="w-[80%] flex items-center justify-end pr-6 gap-4">
        ...
        <div className="relative">
          <button className="w-10 h-10 flex items-center justify-center border border-cyan-400 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-300">
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 w-80 transition-colors duration-500">
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className="px-4 py-2 rounded-lg bg-gray-200 hover:bg-gray-300 text-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white transition-colors duration-300"
              >
                No
              </button>
              <button
                onClick={handleLogout}
                className="px-4 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-700 text-white transition-colors duration-300"
              >
                Yes
              </button>
            </div>
